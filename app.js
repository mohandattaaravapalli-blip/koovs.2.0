...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const exclusiveCapsulesData = {
    spiderman: [
      { id: 'spidey-1', title: 'Spider Hoodie 01', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹7,999' },
      { id: 'spidey-2', title: 'Spider Tee 02', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹5,499' },
      { id: 'spidey-3', title: 'Spider Cargo Pants 03', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹8,999' },
      { id: 'spidey-4', title: 'Spider Washed Jacket 04', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹9,499' },
      { id: 'spidey-5', title: 'Symbiote Heavy Crewneck 05', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹6,999' },
      { id: 'spidey-6', title: 'Web-Slinger Denim Jeans 06', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹8,499' },
      { id: 'spidey-7', title: 'Oscorp Tech Anorak 07', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹9,999' },
      { id: 'spidey-8', title: 'Daily Bugle Vintage Tee 08', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹5,999' },
      { id: 'spidey-9', title: 'Peter Parker Flannel Shirt 09', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹6,499' },
      { id: 'spidey-10', title: 'Miles Morales Track Pants 10', tag: 'SPIDER-MAN: BRAND NEW DAY', price: '₹8,999' }
    ],
    drake: [
      { id: 'drake-1', title: 'Drake Oversized Tee 01', tag: 'DRAKE CONCERT COLLECTION', price: '₹6,499' },
      { id: 'drake-2', title: 'Drake Gold Owl Hoodie 02', tag: 'DRAKE CONCERT COLLECTION', price: '₹7,999' },
      { id: 'drake-3', title: 'Drake Heavy Trousers 03', tag: 'DRAKE CONCERT COLLECTION', price: '₹8,999' },
      { id: 'drake-4', title: 'Drake Leather Varsity Jacket 04', tag: 'DRAKE CONCERT COLLECTION', price: '₹9,999' },
      { id: 'drake-5', title: 'Nocturna Tour Sweatshirt 05', tag: 'DRAKE CONCERT COLLECTION', price: '₹6,999' },
      { id: 'drake-6', title: 'Champagne Papi Silk Shirt 06', tag: 'DRAKE CONCERT COLLECTION', price: '₹7,499' },
      { id: 'drake-7', title: 'Certified Lover Denim 07', tag: 'DRAKE CONCERT COLLECTION', price: '₹8,999' },
      { id: 'drake-8', title: 'Her Loss Washed Cap & Tee 08', tag: 'DRAKE CONCERT COLLECTION', price: '₹5,499' },
      { id: 'drake-9', title: 'Revenge Tour Tracksuit 09', tag: 'DRAKE CONCERT COLLECTION', price: '₹9,499' },
      { id: 'drake-10', title: "October's Very Own Shorts 10", tag: 'DRAKE CONCERT COLLECTION', price: '₹5,999' }
    ],
    cjp: [
      { id: 'cjp-1', title: 'CJP Rally Tee 01', tag: 'CJP PROTEST COLLECTION', price: '₹5,999' },
      { id: 'cjp-2', title: 'CJP Distressed Hoodie 02', tag: 'CJP PROTEST COLLECTION', price: '₹7,499' },
      { id: 'cjp-3', title: 'CJP Tactical Cargo 03', tag: 'CJP PROTEST COLLECTION', price: '₹8,999' },
      { id: 'cjp-4', title: 'CJP Denim Jacket 04', tag: 'CJP PROTEST COLLECTION', price: '₹9,499' },
      { id: 'cjp-5', title: 'Justice Manifesto Sweatshirt 05', tag: 'CJP PROTEST COLLECTION', price: '₹6,999' },
      { id: 'cjp-6', title: 'Activist Utility Vest 06', tag: 'CJP PROTEST COLLECTION', price: '₹7,999' },
      { id: 'cjp-7', title: 'Liberation Heavy Trousers 07', tag: 'CJP PROTEST COLLECTION', price: '₹8,499' },
      { id: 'cjp-8', title: 'Unity Graphic Longsleeve 08', tag: 'CJP PROTEST COLLECTION', price: '₹5,499' },
      { id: 'cjp-9', title: 'Freedom Heavyweight Fleece 09', tag: 'CJP PROTEST COLLECTION', price: '₹7,999' },
      { id: 'cjp-10', title: 'Protest Raw Hem Shorts 10', tag: 'CJP PROTEST COLLECTION', price: '₹5,999' }
    ],
    sabrina: [
      { id: 'sabrina-1', title: 'Sabrina Tour Baby Tee 01', tag: 'SABRINA CARPENTER TOUR', price: '₹4,999' },
      { id: 'sabrina-2', title: 'Sabrina Espresso Tee 02', tag: 'SABRINA CARPENTER TOUR', price: '₹5,499' },
      { id: 'sabrina-3', title: 'Sabrina Tour Hoodie 03', tag: 'SABRINA CARPENTER TOUR', price: '₹6,999' },
      { id: 'sabrina-4', title: 'Sabrina Corset Top 04', tag: 'SABRINA CARPENTER TOUR', price: '₹6,499' },
      { id: 'sabrina-5', title: "Short n' Sweet Sweater 05", tag: 'SABRINA CARPENTER TOUR', price: '₹7,499' },
      { id: 'sabrina-6', title: 'Taste Tour Satin Shorts 06', tag: 'SABRINA CARPENTER TOUR', price: '₹5,499' },
      { id: 'sabrina-7', title: 'Please Please Please Denim 07', tag: 'SABRINA CARPENTER TOUR', price: '₹8,499' },
      { id: 'sabrina-8', title: 'Coquette Lace Streetwear Top 08', tag: 'SABRINA CARPENTER TOUR', price: '₹5,999' },
      { id: 'sabrina-9', title: 'Sweetheart Track Pants 09', tag: 'SABRINA CARPENTER TOUR', price: '₹7,999' },
      { id: 'sabrina-10', title: 'Tour VIP Zip-Up Hoodie 10', tag: 'SABRINA CARPENTER TOUR', price: '₹7,999' }
    ],
    avengers: [
      { id: 'avengers-1', title: 'Doomsday Varsity Jacket 01', tag: 'AVENGERS: DOOMSDAY', price: '₹9,999' },
      { id: 'avengers-2', title: 'Doomsday Armor Tee 02', tag: 'AVENGERS: DOOMSDAY', price: '₹6,499' },
      { id: 'avengers-3', title: 'Doomsday Heavy Hoodie 03', tag: 'AVENGERS: DOOMSDAY', price: '₹8,499' },
      { id: 'avengers-4', title: 'Doomsday Cargo Pants 04', tag: 'AVENGERS: DOOMSDAY', price: '₹9,499' },
      { id: 'avengers-5', title: 'Latverian Anorak Shell 05', tag: 'AVENGERS: DOOMSDAY', price: '₹9,999' },
      { id: 'avengers-6', title: 'Victor Von Doom Crewneck 06', tag: 'AVENGERS: DOOMSDAY', price: '₹7,499' },
      { id: 'avengers-7', title: 'Vibranium Tactical Vest 07', tag: 'AVENGERS: DOOMSDAY', price: '₹8,999' },
      { id: 'avengers-8', title: 'Stark Tech Joggers 08', tag: 'AVENGERS: DOOMSDAY', price: '₹7,999' },
      { id: 'avengers-9', title: 'Multiverse Graphic Longsleeve 09', tag: 'AVENGERS: DOOMSDAY', price: '₹6,499' },
      { id: 'avengers-10', title: 'Endgame Oversized Tee 10', tag: 'AVENGERS: DOOMSDAY', price: '₹5,999' }
    ],
    f1: [
      { id: 'f1-1', title: 'F1 Paddock Track Pants 01', tag: 'FORMULA ONE WEEKEND', price: '₹8,999' },
      { id: 'f1-2', title: 'F1 Pit Crew Jacket 02', tag: 'FORMULA ONE WEEKEND', price: '₹9,999' },
      { id: 'f1-3', title: 'F1 Apex Heavy Tee 03', tag: 'FORMULA ONE WEEKEND', price: '₹5,999' },
      { id: 'f1-4', title: 'F1 Telemetry Hoodie 04', tag: 'FORMULA ONE WEEKEND', price: '₹7,499' },
      { id: 'f1-5', title: 'Monaco Grand Prix Sweater 05', tag: 'FORMULA ONE WEEKEND', price: '₹7,999' },
      { id: 'f1-6', title: 'Silverstone Racing Shorts 06', tag: 'FORMULA ONE WEEKEND', price: '₹5,499' },
      { id: 'f1-7', title: 'Paddock Club Leather Jacket 07', tag: 'FORMULA ONE WEEKEND', price: '₹10,999' },
      { id: 'f1-8', title: 'Checkered Flag Longsleeve 08', tag: 'FORMULA ONE WEEKEND', price: '₹6,499' },
      { id: 'f1-9', title: 'Pole Position Cargo Pants 09', tag: 'FORMULA ONE WEEKEND', price: '₹8,499' },
      { id: 'f1-10', title: 'Scuderia Vintage Tee 10', tag: 'FORMULA ONE WEEKEND', price: '₹5,999' }
    ],
    nba: [
      { id: 'nba-1', title: 'NBA Courtside Tee 01', tag: 'NBA FINALS COLLECTION', price: '₹5,999' },
      { id: 'nba-2', title: 'NBA Mesh Jersey 02', tag: 'NBA FINALS COLLECTION', price: '₹6,499' },
      { id: 'nba-3', title: 'NBA MVP Hoodie 03', tag: 'NBA FINALS COLLECTION', price: '₹7,999' },
      { id: 'nba-4', title: 'NBA Satin Bomber 04', tag: 'NBA FINALS COLLECTION', price: '₹9,499' },
      { id: 'nba-5', title: 'Hardwood Classic Trousers 05', tag: 'NBA FINALS COLLECTION', price: '₹8,499' },
      { id: 'nba-6', title: 'Championship Warmup Pants 06', tag: 'NBA FINALS COLLECTION', price: '₹7,999' },
      { id: 'nba-7', title: 'Draft Night Vintage Jacket 07', tag: 'NBA FINALS COLLECTION', price: '₹9,999' },
      { id: 'nba-8', title: 'Hall of Fame Heavy Tee 08', tag: 'NBA FINALS COLLECTION', price: '₹5,499' },
      { id: 'nba-9', title: 'Retro Basketball Shorts 09', tag: 'NBA FINALS COLLECTION', price: '₹5,999' },
      { id: 'nba-10', title: 'Finals VIP Crewneck 10', tag: 'NBA FINALS COLLECTION', price: '₹6,999' }
    ],
    anime: [
      { id: 'anime-1', title: 'Cyberpunk Neo-Tokyo Tee 01', tag: 'ANIME CAPSULE', price: '₹6,999' },
      { id: 'anime-2', title: 'Shinigami Flame Hoodie 02', tag: 'ANIME CAPSULE', price: '₹7,999' },
      { id: 'anime-3', title: 'Mech Unit Tactical Pants 03', tag: 'ANIME CAPSULE', price: '₹8,999' },
      { id: 'anime-4', title: 'Akira Distressed Jacket 04', tag: 'ANIME CAPSULE', price: '₹9,999' },
      { id: 'anime-5', title: 'Evangelion Oversized Crewneck 05', tag: 'ANIME CAPSULE', price: '₹7,499' },
      { id: 'anime-6', title: 'Hunter Acid Wash Tee 06', tag: 'ANIME CAPSULE', price: '₹5,999' },
      { id: 'anime-7', title: 'Manga Panel Denim 07', tag: 'ANIME CAPSULE', price: '₹8,999' },
      { id: 'anime-8', title: 'Shinobi Masked Hoodie 08', tag: 'ANIME CAPSULE', price: '₹7,999' },
      { id: 'anime-9', title: 'Kaiju Heavy Longsleeve 09', tag: 'ANIME CAPSULE', price: '₹6,499' },
      { id: 'anime-10', title: 'Mech Pilot Track Shorts 10', tag: 'ANIME CAPSULE', price: '₹5,499' }
    ],
    festival: [
      { id: 'festival-1', title: 'Festival VIP Hoodie 01', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹7,999' },
      { id: 'festival-2', title: 'Festival Holographic Tee 02', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹5,999' },
      { id: 'festival-3', title: 'Festival Mud-Wash Shorts 03', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹6,499' },
      { id: 'festival-4', title: 'Festival Lineup Longsleeve 04', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹6,999' },
      { id: 'festival-5', title: 'Mainstage Anorak Jacket 05', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹9,499' },
      { id: 'festival-6', title: 'Rave Glow Mesh Top 06', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹5,499' },
      { id: 'festival-7', title: 'Backstage Pass Cargo Pants 07', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹8,999' },
      { id: 'festival-8', title: 'Sunset Amphitheater Sweater 08', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹7,499' },
      { id: 'festival-9', title: 'Pyrotechnic Heavy Tee 09', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹5,999' },
      { id: 'festival-10', title: 'DJ Booth Distressed Denim 10', tag: 'MUSIC FESTIVAL COLLECTION', price: '₹8,999' }
    ],
    archive: [
      { id: 'archive-1', title: 'Vault 01 Pleated Trousers', tag: 'KOOVS LIMITED ARCHIVE', price: '₹8,999' },
      { id: 'archive-2', title: 'Vault 02 Heavy Hoodie', tag: 'KOOVS LIMITED ARCHIVE', price: '₹7,999' },
      { id: 'archive-3', title: 'Vault 03 Canvas Jacket', tag: 'KOOVS LIMITED ARCHIVE', price: '₹9,999' },
      { id: 'archive-4', title: 'Vault 04 Oversized Tee', tag: 'KOOVS LIMITED ARCHIVE', price: '₹5,499' },
      { id: 'archive-5', title: 'Vault 05 Vintage Crewneck', tag: 'KOOVS LIMITED ARCHIVE', price: '₹6,999' },
      { id: 'archive-6', title: 'Vault 06 Raw Denim Shorts', tag: 'KOOVS LIMITED ARCHIVE', price: '₹5,999' },
      { id: 'archive-7', title: 'Vault 07 Tactical Vest', tag: 'KOOVS LIMITED ARCHIVE', price: '₹7,999' },
      { id: 'archive-8', title: 'Vault 08 Distressed Sweater', tag: 'KOOVS LIMITED ARCHIVE', price: '₹7,499' },
      { id: 'archive-9', title: 'Vault 09 Leather Bomber', tag: 'KOOVS LIMITED ARCHIVE', price: '₹11,999' },
      { id: 'archive-10', title: 'Vault 10 Monogram Cargo Pants', tag: 'KOOVS LIMITED ARCHIVE', price: '₹8,999' }
    ]
  };
